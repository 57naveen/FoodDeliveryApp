...
const placeOrder = async (req, res) => {
    const frontend_url = "https://food-del-frontend-njbb.onrender.com";
    ...
    try {
      ...
      const line_items = req.body.items.map((item) => ({
        price_data: {
          ...
          unit_amount: item.price * 100, // Correct price to paise
        },
      ...
      line_items.push({
        price_data: {
          ...
          unit_amount: 50 * 100, // Delivery charge in paise
        },
        quantity: 1,
      });
